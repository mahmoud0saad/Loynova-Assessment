...
mixin _$TransferRequest {
 ...
 String get recipient; int get points; String? get note;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TransferRequest&&(identical(other.recipient, recipient) || other.recipient == recipient)&&(identical(other.points, points) || other.points == points)&&(identical(other.note, note) || other.note == note));
}
...
@override
String toString() {
  return 'TransferRequest(recipient: $recipient, points: $points, note: $note)';
}
...
/// Create a copy of TransferRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? recipient = null,Object? points = null,Object? note = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String recipient,  int points,  String? note)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransferRequest() when $default != null:
return $default(_that.recipient,_that.points,_that.note);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String recipient,  int points,  String? note)  $default,) {final _that = this;
switch (_that) {
case _TransferRequest():
return $default(_that.recipient,_that.points,_that.note);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String recipient,  int points,  String? note)?  $default,) {final _that = this;
switch (_that) {
case _TransferRequest() when $default != null:
return $default(_that.recipient,_that.points,_that.note);case _:
  return null;
...
class _TransferRequest implements TransferRequest {
  const _TransferRequest({required this.recipient, required this.points, this.note});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TransferRequest&&(identical(other.recipient, recipient) || other.recipient == recipient)&&(identical(other.points, points) || other.points == points)&&(identical(other.note, note) || other.note == note));
}
...
/// Create a copy of TransferRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? recipient = null,Object? points = null,Object? note = freezed,}) {
